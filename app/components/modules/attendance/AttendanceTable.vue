			...
			<tbody class="divide-y divide-gray-100 dark:divide-gray-800">
				...
				>
					...
					<td class="px-4 py-3 text-center whitespace-nowrap">
						<button
							:title="record.checkInPhotoUrl || record.checkOutPhotoUrl ? 'Xem ảnh chấm công' : 'Chưa có ảnh'"
							...
							"
							@click="(record.checkInPhotoUrl || record.checkOutPhotoUrl) && emit('viewPhoto', record)"
						>
